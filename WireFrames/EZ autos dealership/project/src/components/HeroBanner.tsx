          ...
          <div className="max-w-2xl">
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg animate-slide-up">
              <div className="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition-colors duration-200 flex items-center justify-center">
            ...
            <div className="flex flex-wrap gap-3 mt-6 animate-fade-in-delay-2">
              <button className="bg-white/20 hover:bg-white/30 text-white text-sm font-medium py-2 px-4 rounded-full backdrop-blur-sm transition-colors">
                SUVs
              </button>
              <button className="bg-white/20 hover:bg-white/30 text-white text-sm font-medium py-2 px-4 rounded-full backdrop-blur-sm transition-colors">
                Sedans
